...
* [LineIcons](https://lineicons.com): 2000+ Line Icons for Designers and Developers. Handcrafted Line Icons for Modern User Interfaces of Web, Android, iOS, and Desktop App Projects. A Complete Yet Most Simplified Icon Pack Available on The Web!
...
* [Material Design](https://github.com/templarian/MaterialDesign): ✒5400+ Material Design Icons from the Community.
* [coreui icons](https://icons.coreui.io/icons): Premium designed free icon set with marks in SVG, Webfont and raster formats. CoreUI Icons are beautifully crafted symbols for common actions and items. You can use them in your digital products for web or mobile app.
* [orion](https://orioniconlibrary.com): The best Icon Tool. 8000+ Free SVG & PNG Icons. Search, organize, edit and download our highly flexible Icons.
* [pixellove](https://www.pixellove.com): Download 15,000 icons in 6 distictive styles made for professionals.
* [Iconic](https://useiconic.com): Meet Iconic. The definitive icon set designed for the modern web.
* [iconscout](https://iconscout.com): Browse 2 Million+ high quality Icons, Illustrations and royalty-free stock photos at one place. Download Now!
* [Design Bombs - Droppin' design bombs everyday!](https://designbombs.com): DesignBombs is an online publication that aims to provide well-researched guides, in-depth tutorials, exclusive deals, and other useful content.
* ...
